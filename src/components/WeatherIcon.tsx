...
const WeatherIcon: React.FC<WeatherIconProps> = ({
  ...
  const weatherIcons: Record<number, { day: string; night: string }> = {
    ...
    1075: {
      day: "partly-cloudy-night-drizzle",
      night: "partly-cloudy-night-drizzle",
    },
    1078: { day: "partly-cloudy-night-fog", night: "partly-cloudy-night-fog" },
    1081: {
      day: "partly-cloudy-night-hail",
      night: "partly-cloudy-night-hail",
    },
    1084: {
      day: "partly-cloudy-night-haze",
      night: "partly-cloudy-night-haze",
    },
    1087: {
      day: "partly-cloudy-night-rain",
      night: "partly-cloudy-night-rain",
    },
    1090: {
      day: "partly-cloudy-night-sleet",
      night: "partly-cloudy-night-sleet",
    },
    1093: {
      day: "partly-cloudy-night-smoke",
      night: "partly-cloudy-night-smoke",
    },
    1096: {
      day: "partly-cloudy-night-snow",
  ...
  const iconName =
    (isDay ? weatherIcons[code]?.day : weatherIcons[code]?.night) ??
    "not-available";
  const size = 70;
  ...
  return (
    <div className={`flex flex-row ${className}`}>
      <Image
        ...
        alt={`Weather icon for code ${code}`}
        width={size}
        height={size}
      />
    </div>
